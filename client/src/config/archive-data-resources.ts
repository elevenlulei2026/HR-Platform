...
import {
  ...
  BACKGROUND_TITLE_CERTIFICATE_FIELDS,
...
> = [
  ...
  },
  {
    ...
    section: "service",
    supported: true,
    description: "跨员工维护档案附件：页面上传文件，可导出台账（不含文件本体）",
    formFields: SERVICE_ATTACHMENT_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      { key: "attachmentType", label: "附件类型" },
  ...
  },
  {
    ...
    section: "background",
    supported: true,
    description: "跨员工批量维护教育经历，支持导入导出",
    formFields: BACKGROUND_EDUCATION_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      ...
      { key: "startDate", label: "开始日期" },
      { key: "endDate", label: "结束日期" },
      { key: "isHighest", label: "最高学历" },
    ],
    importConfig: {
      businessKeyHint: "同工号 + 学校 + 开始日期已存在则更新，否则新建。",
      fillSubHint: "学历/学位/国家地区请填字典名称或编码；最高学历填「是/否」",
      templateSheetHint: "含「教育经历」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、学校" },
        { text: "业务键：同工号 + 学校 + 开始日期 → 更新；否则新建" },
      ],
    },
  },
  {
    ...
    section: "background",
    supported: true,
    description: "跨员工批量维护工作经历，支持导入导出",
    formFields: BACKGROUND_WORK_EXP_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      { key: "employerName", label: "单位" },
    ...
    importConfig: {
      businessKeyHint: "同工号 + 单位 + 开始日期已存在则更新，否则新建。",
      fillSubHint: "货币代码可填字典名称或编码",
      templateSheetHint: "含「工作经历」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、单位" },
        { text: "业务键：同工号 + 单位 + 开始日期 → 更新；否则新建" },
      ],
    },
  },
  {
    ...
    section: "background",
    supported: true,
    description: "跨员工批量维护资格证书，支持导入导出",
    formFields: BACKGROUND_QUALIFICATION_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      ...
      { key: "firstIssueDate", label: "获证日期" },
      { key: "expiryDate", label: "到期日" },
      { key: "issuingOrg", label: "发证机构" },
    ],
    importConfig: {
      businessKeyHint: "同工号 + 证书名称 + 证书号码已存在则更新，否则新建。",
      templateSheetHint: "含「资格证书」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、证书名称" },
        { text: "业务键：同工号 + 证书名称 + 证书号码 → 更新；否则新建" },
      ],
    },
  },
  {
    path: "title-certificates",
    title: "职称证书",
    section: "background",
    supported: true,
    description: "跨员工批量维护职称证书，支持导入导出",
    formFields: BACKGROUND_TITLE_CERTIFICATE_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      { key: "titleName", label: "职称名称" },
      { key: "titleLevel", label: "职称级别" },
      { key: "certificateNo", label: "证书号码" },
      { key: "approvalDate", label: "批准日期" },
      { key: "expiryDate", label: "到期日" },
      { key: "issuingOrg", label: "签发单位" },
    ],
    importConfig: {
      businessKeyHint: "同工号 + 职称名称 + 证书号码已存在则更新，否则新建。",
      templateSheetHint: "含「职称证书」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、职称名称" },
        { text: "业务键：同工号 + 职称名称 + 证书号码 → 更新；否则新建" },
      ],
    },
  },
  {
    ...
    section: "background",
    supported: true,
    description: "跨员工批量维护奖励记录，支持导入导出",
    formFields: BACKGROUND_REWARD_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
    ...
    importConfig: {
      businessKeyHint: "同工号 + 奖励类型 + 生效日期已存在则更新，否则新建。",
      templateSheetHint: "含「奖励记录」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、奖励类型（名称或编码，与档案页父子值一致）" },
        { text: "级别：特殊嘉奖等有二级选项时必填；一般奖励无级别请留空" },
        { text: "发放方式：工资发放 / 现金发放（或对应编码）" },
        { text: "业务键：同工号 + 奖励类型 + 生效日期 → 更新；否则新建" },
      ],
    },
  },
  {
    ...
    section: "background",
    supported: true,
    description: "跨员工批量维护惩处记录，支持导入导出",
    formFields: BACKGROUND_PENALTY_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      ...
      { key: "effectiveDate", label: "生效日期" },
      { key: "amount", label: "金额" },
      { key: "involvesCompensation", label: "涉及赔偿" },
      { key: "issuingOrg", label: "发文单位" },
    ],
    importConfig: {
      businessKeyHint: "同工号 + 惩处类型 + 生效日期已存在则更新，否则新建。",
      fillSubHint: "涉及赔偿请填「是 / 否」；惩处类型/类别可填名称或编码",
      templateSheetHint: "含「惩处记录」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、惩处类型（名称或编码，与档案页父子值一致）" },
        { text: "惩处类别：行政处罚等有二级选项时必填；经济处罚无类别请留空" },
        { text: "扣款方式填字典名称或编码；涉及赔偿填是/否" },
        { text: "业务键：同工号 + 惩处类型 + 生效日期 → 更新；否则新建" },
      ],
    },
  },
  {
    ...
    section: "development",
    supported: true,
    description: "跨员工批量维护培训记录，支持导入导出",
    formFields: TALENT_TRAINING_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      ...
      { key: "assessmentResult", label: "考核结果" },
      { key: "trainingType", label: "培训类型" },
      { key: "trainingCost", label: "培训费用(元)" },
    ],
    importConfig: {
      businessKeyHint: "同工号 + 课程名称 + 开始日期已存在则更新，否则新建。",
      fillSubHint: "考核方式/考核结果/培训形式/培训类型请填字典名称或编码",
      templateSheetHint: "含「培训记录」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、课程名称" },
        { text: "业务键：同工号 + 课程名称 + 开始日期 → 更新；否则新建" },
        { text: "时长、培训费用需为数字；日期格式 YYYY-MM-DD" },
      ],
    },
  },
  {
    ...
    section: "development",
    supported: true,
    description: "跨员工批量维护绩效记录，支持导入导出",
    formFields: TALENT_PERFORMANCE_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      { key: "year", label: "年度" },
      { key: "assessmentType", label: "考核类型" },
      { key: "performanceStartDate", label: "绩效开始日期" },
      { key: "performanceEndDate", label: "绩效结束日期" },
      { key: "valuesLevel", label: "价值观等级" },
      { key: "performanceLevel", label: "绩效等级" },
      { key: "performanceScore", label: "绩效得分" },
      { key: "valuesScore", label: "价值观得分" },
    ],
    importConfig: {
      businessKeyHint: "同工号 + 年度 + 考核类型 + 绩效开始日期已存在则更新，否则新建。",
      fillSubHint: "考核类型/价值观等级/绩效等级请填字典名称或编码",
      templateSheetHint: "含「绩效记录」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、年度" },
        { text: "业务键：同工号 + 年度 + 考核类型 + 绩效开始日期 → 更新；否则新建" },
        { text: "绩效得分、价值观得分为文本字段，可填分数或等级描述" },
      ],
    },
  },
  {
    path: "values-assessments",
    title: "价值观评估",
    section: "development",
    supported: true,
    description: "跨员工批量维护价值观评估，支持导入导出",
    formFields: TALENT_VALUES_FIELDS,
    listColumns: [
      { key: "employeeNo", label: "工号" },
      { key: "employeeName", label: "姓名" },
      { key: "organizationName", label: "部门" },
      { key: "assessmentTime", label: "考核时间" },
    ...
    importConfig: {
      businessKeyHint: "同工号 + 考核时间已存在则更新，否则新建。",
      templateSheetHint: "含「价值观评估」数据表与「说明」工作表",
      fillHints: [
        { text: "必填：工号、考核时间" },
        { text: "业务键：同工号 + 考核时间 → 更新；否则新建" },
        { text: "红黄绿灯可填分值或简短说明" },
      ],
    },
  },
