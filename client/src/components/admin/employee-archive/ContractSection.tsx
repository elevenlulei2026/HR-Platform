            ...
            {items.map((item) => {
              ...
              return (
                <ArchiveRecordCard
                  ...
                  accent={indefinite ? "amber" : "primary"}
                  actions={
                    <>
                ...
                >
                  <ArchiveRecordFieldGrid columns={4}>
                    ...
                    <ArchiveRecordField label="合同期限" value={periodDisplay} compact />
                    <ArchiveRecordField label="状态" value={statusBadge} compact />
                  </ArchiveRecordFieldGrid>
                </ArchiveRecordCard>
              );
            })}
