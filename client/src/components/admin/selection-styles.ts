...
export const adminChipIdle =
  "border-border/70 bg-background text-foreground transition-[border-color,background-color,box-shadow] duration-200 ease-out hover:border-primary/30 hover:bg-primary/[0.03]";
...
export const adminSegmentIdle =
  "text-muted-foreground transition-[color,background-color,box-shadow] duration-200 ease-out hover:text-foreground";
...
export const adminPillIdle =
  "text-muted-foreground transition-colors duration-200 hover:bg-muted/70 hover:text-foreground";
