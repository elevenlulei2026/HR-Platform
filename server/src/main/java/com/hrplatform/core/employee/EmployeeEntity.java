...
public class EmployeeEntity {
  ...
  public void setHighestEducationGradDate(LocalDate highestEducationGradDate) {
    this.highestEducationGradDate = highestEducationGradDate;
  }
  ...
  public void setPartyOrgTransferred(Boolean partyOrgTransferred) {
    this.partyOrgTransferred = partyOrgTransferred;
  }
  ...
  public void setRecruitmentChannelDetail(String recruitmentChannelDetail) {
    this.recruitmentChannelDetail = recruitmentChannelDetail;
  }
